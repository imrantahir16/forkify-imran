...
export default class View {
   ...
   * @param {object | Object[]} data The to be render (e.g. recipe)
  ...
  // updating algorithm where we want to update elemen text where occure change only the rest remain the same
  update(data) {
    this._data = data;
